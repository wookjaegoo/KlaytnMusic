...
function authentifier()
{
  return(
    ...
    <button onClick={onChange2} style={{width:'50px'}}>확인</button>
...
{  (checkeditems.has("장애인증명서")&&isexist)&& 
 ...
 <img src={`https://chart.apis.google.com/chart?cht=qr&chs=100x100&chl=${imageUrl.url}`} style={{marginBottom:'100%'}}>
</img> 
</div> }
...
<div className='Authentication3'
  style={{backgroundImage:`url(${imageUrl2.url})`}}>
    
 <img src={`https://chart.apis.google.com/chart?cht=qr&chs=100x100&chl=${imageUrl2.url}`}  style={{marginBottom:'100%'}}>
</img>
